...
public class Api {
  ...
  public ShardedId defineCustomer(ShardedId eid, CustomerValue value,
  ...
  public ShardedId defineCustomer(ShardedId eid) {
  ...
  public ListServicemen.Model[] queryServicemen(UUID projectId) {
    var address = ListServicemen.Request.ADDRESS;
    var request = new ListServicemen.Request(projectId);
    return sync.ask(address, request, ListServicemen.Request.class, ListServicemen.Response.class).getItems();
  }
