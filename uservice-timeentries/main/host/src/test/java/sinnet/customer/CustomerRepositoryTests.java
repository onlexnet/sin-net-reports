...
public class CustomerRepositoryTests {
  ...
  void saveMinModel() {
    ...
    var customerId = api.defineCustomer(ShardedId.anyNew(projectId.getId()), model);
  ...
  public void list() {
    var projectId = api.createNewProject();
    var id1 = api.defineCustomer(ShardedId.anyNew(projectId));
    var id2 = api.defineCustomer(ShardedId.anyNew(projectId));
  ...
  public void shouldUpdate() {
    ...
    var eidV1 = api.defineCustomer(ShardedId.anyNew(projectId), validModel);
  ...
  public void shouldNotDeleteLastVersionIfNewSaveFailed() {
    var projectId = api.createNewProject();
    var validModel = Given.minValidModel();
    var eid = api.defineCustomer(ShardedId.anyNew(projectId), validModel);
  ...
  public void shouldNotSaveWhenVersionIsNotNext() {
    ...
    var eid = api.defineCustomer(ShardedId.anyNew(projectId));

    var invalidEid = ShardedId.of(eid.getProjectId(), eid.getId(), eid.getVersion() + 1);
  ...
  public class ShouldSupportSecrets {
    ...
    void write() {
      ...
      var someId = ShardedId.anyNew(projectId);
      var model = Given.minValidModel();
    ...
    public class ShouldSupportSecretsEx {
      ...
      void write() {
        ...
        var someId1 = ShardedId.anyNew(projectId);
        var someId2 = ShardedId.anyNew(projectId);
        var model = Given.minValidModel();
        ...
        var customers = Sync.of(customerProjection.findByProjectId(projectId.getId())).get().flatMap(it -> Array.of(it.getSecretsEx()));
