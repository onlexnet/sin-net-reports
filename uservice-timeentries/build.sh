...
# Build script for uservice-timeentries that automatically builds shared dependencies
# This replaces the manual 3-step build process with a single command

set -e  # Exit on any error

echo "Building shared dependencies for uservice-timeentries..."
...
echo "Building uservice-timeentries..."
